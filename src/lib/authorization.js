...
exports.ticketScope = ticketScope;
exports.isAgentOrAdmin = isAgentOrAdmin;
exports.isSameOrganization = isSameOrganization;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(session === null || session === void 0 ? void 0 : session.user)) {
                        return [2 /*return*/, {
                                ok: false,
                                response: server_1.NextResponse.json({ error: "Unauthorized" }, { status: 401 }),
                            }];
                    }
                    user = {
                        id: session.user.id,
...
function ticketScope(user) {
    ...
    return user.role === "REQUESTER"
        ? { requesterId: user.id }
        : { organizationId: (_a = user.organizationId) !== null && _a !== void 0 ? _a : undefined };
}
function isAgentOrAdmin(user) {
