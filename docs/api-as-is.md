...
## /api/tickets
- **GET**: Lists tickets scoped by role (requester ‘ÊÂ own tickets; agent/admin ‘ÊÂ organization tickets). Requires authenticated session; returns 401 otherwise.—«…F:src/app/api/tickets/route.ts‘«·L16-L38—«≈
