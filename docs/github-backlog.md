...
=======
- **Phase 0:** foundations/contracts ready, auth/policy helpers, sanitizer, contract tests enforced, checkpoints approved.
- **MVP (P0):** attachments, categories, SLA placeholders, rate limits, notification stubs, audit hooks, checkpoints 3–5 approved.
- **V1 (P1):** workers for SLA/notifications, automation, admin auditability, dashboards, checkpoints 6–7 approved.
- **V2 (P2):** reporting/CSAT/UX polish, observability/metrics/alerts, compliance, regression/load suites, release gates approved.
